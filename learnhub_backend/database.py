...
class DB_client(MongoClient):
    def __init__(self, *args, **kwargs):
        ...
        self.thread_reply_coll = self.db[DB_THREAD_REPLY_COLLECTION]
        self.assignment_reply_coll = self.db[DB_ASSIGNMENT_REPLY_COLLECTION]
