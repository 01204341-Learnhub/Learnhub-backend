...
from .database import place_holder_db,query_wishlist,query_class_or_course
from .schemas import (
    place_holder_model,
...
def get_wishlist_response(
    ...
    for item in wishlist:
        ...
        program = query_class_or_course(program_id=item["program_id"], program_type=item["type"])
